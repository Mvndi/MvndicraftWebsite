...
export default function NavBar() {
    ...
    return (
        <>
            <div className="hidden md:block sticky top-0 z-40 bg-black h-9">
            ...
            <div className="md:hidden sticky top-0 z-40 bg-black h-9 border-b border-[#333]">
            ...
            <nav className="sticky top-[36px] z-50 border-b border-[#333] bg-[#101015]/80 backdrop-blur-md">
