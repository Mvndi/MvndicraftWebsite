        ...
        <Link href="https://www.youtube.com/@mvndicraft4233" target="_blank" rel="noreferrer" className="flex items-center hover:text-[#E2B714] transition-colors px-2 h-full">
            ...
            <div className="relative z-10 border-b border-[#333] bg-[#101015]/80 backdrop-blur-md">
                ...
                <div className={`md:hidden absolute w-full border-t border-[#333] bg-[#101015]/95 backdrop-blur-md flex flex-col text-white text-xs uppercase font-bold tracking-widest shadow-xl transition-all duration-300 overflow-hidden ${menuOpen ? "max-h-64 opacity-100" : "max-h-0 opacity-0 border-0"}`}>
                    <Link href="#" onClick={() => setMenuOpen(false)} className="px-6 py-4 hover:bg-[#1a1a1f] hover:text-[#E2B714] transition-colors">Home</Link>
                    <Link href="https://www.planetminecraft.com/server/mvndicraft-medieval-geopol/" target="_blank" rel="noreferrer" onClick={() => setMenuOpen(false)} className="px-6 py-4 hover:bg-[#1a1a1f] hover:text-[#E2B714] transition-colors">Vote</Link>
                    <Link href="#" onClick={() => setMenuOpen(false)} className="px-6 py-4 bg-[#26262a] hover:text-[#E2B714] transition-colors">Wiki</Link>
                    <Link href="https://www.patreon.com/Mvndicraft" target="_blank" rel="noreferrer" onClick={() => setMenuOpen(false)} className="px-6 py-4 border-t border-[#333] text-[#E2B714] flex items-center gap-2 hover:bg-[#1a1a1f] transition-colors">
