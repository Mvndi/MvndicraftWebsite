            ...
            <div className="relative z-10 flex flex-col items-center gap-6 text-center px-4 md:px-8">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4 mt-4 w-full px-4 sm:px-0">
                    <button
                        ...
                        className="w-full sm:w-auto bg-[#E2B714] text-[#111114] px-8 md:px-12 py-4 font-black uppercase tracking-widest text-sm rounded cursor-pointer hover:bg-yellow-500 transition-all shadow-[0_0_30px_rgba(226,183,20,0.4)]"
                    >
                        mc.mvndicraft.net
                    </button>
                    <Link
                        ...
                        className="w-full sm:w-auto flex items-center justify-center gap-3 border border-white/20 text-white px-8 md:px-12 py-4 font-black uppercase tracking-widest text-sm rounded hover:border-[#E2B714]/60 transition-all"
                    >
