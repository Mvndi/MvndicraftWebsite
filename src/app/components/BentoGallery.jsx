...
export default function BentoGallery() {
    return (
        <section className="w-full max-w-7xl mx-auto px-4 md:px-8 mt-20" aria-labelledby="gallery-heading">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 w-full" role="list" aria-label="Game features gallery">
                <article className="md:col-span-2 relative rounded-2xl overflow-hidden group h-48 md:h-80 lg:h-96 w-full" role="listitem">
                    <Image 
                        src="/image/ArabAttack_1.png" 
                        alt="Massive medieval army battle with siege engines and cavalry on Mvndicraft server" 
                ...
                <div className="grid grid-cols-2 md:grid-cols-1 gap-4 w-full">
                    <article className="relative rounded-2xl overflow-hidden group h-32 md:h-40 w-full" role="listitem">
                        <Image 
                            src="/image/FightingByz.png" 
                            alt="Intense PvP combat between Byzantine warriors in medieval armor on Mvndicraft" 
                            width={9999} height={9999}
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                        />
                    ...
                    <article className="relative rounded-2xl overflow-hidden group h-32 md:h-40 w-full" role="listitem">
                        <Image 
                            src="/image/ThumbnailAchillle23s.png" 
                            alt="Medieval civilization and kingdom building on Mvndicraft server" 
                            width={9999} height={9999}
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" aria-hidden="true" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4 w-full" role="list" aria-label="Additional game features">
                <article className="relative rounded-2xl overflow-hidden group h-36 md:h-44 w-full" role="listitem">
                    <Image 
                        src="/image/KinoThumbnail.png" 
                        alt="Medieval faction system and political gameplay on Mvndicraft" 
                        width={9999} height={9999}
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" aria-hidden="true" />
                ...
                <article className="relative rounded-2xl overflow-hidden group h-36 md:h-44 w-full" role="listitem">
                    <Image 
                        src="/image/San_Giorgio.png" 
                        alt="Medieval city building and architecture on Mvndicraft server" 
                        width={9999} height={9999}
                        className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" 
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/10 to-transparent" aria-hidden="true" />
                ...
                <article className="relative rounded-2xl overflow-hidden group h-36 md:h-44 w-full" role="listitem">
                    <Image 
                        src="/image/army.png" 
                        alt="Join the medieval warfare battle on Mvndicraft server" 
                        width={9999} height={9999}
